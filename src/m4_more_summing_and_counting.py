...
def run_test_count_cosines_from():
    ...
    # Test 6:
    expected = 4
    answer = count_cosines_from(1, 9, 0.11)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.535217  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(6, 69)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 3.019877  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 11)
